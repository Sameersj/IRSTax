...
function fnGo()
{
	document.frmPost.action = "ordersplaced.asp";
							...
							<table>
						        ...
						        <table align=center cellspacing=0 cellpadding =0 border="0" >
							        <tr valign="top">
					        			...
					        			<td width="13%"><input type="button" name="submit2" value="GO" onclick="javascript:fnGo();"></td>
				        			</tr>
											<tr><td colspan="3">&nbsp;</td></tr>
							        <tr>
							        	<td colspan="3"><font size="2" face="Arial"><b>Count of Years for Orders Placed in above date range : <%=count%></b></font></td>
							        </tr>
											<tr><td colspan="3">&nbsp;</td></tr>
											<tr>
							        	<td colspan="3"><font size="2" face="Arial"><b>Billing amount for above count = $4.50 X <%=count%>&nbsp;&nbsp; = &nbsp;&nbsp;</b></font>
												<font size="3" face="Arial"><b>
												<%
													dim amount
													amount = CDbl(4.5) * count
